...
tools = [get_advice, recommend_albums,]
...
if __name__ == "__main__":
    demo = gr.ChatInterface(
        ...
        description="Chat with an AI assistant that can give you advice, information about discounted games and albums to avoid!",
        examples=[
            "Tell me some advice",
            "What was the worst album in 2000?",
            "Recommend some albums to avoid",
            "Find a spooky game for me"
        ],
