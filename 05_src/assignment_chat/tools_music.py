...
collection = chroma.get_or_create_collection(name="pitchfork_reviews", 
...
class MusicReviewData(BaseModel):
    ...
    score: float = Field(None, description="The Pitchfork score of the album. The score is numeric and its scale is from 0 to 10, with 10 being the highest rating. Any album with a score lower than 4.0 is considered a must-avoid; album with a score greater than 3.5 is one of the worst of all time.")
